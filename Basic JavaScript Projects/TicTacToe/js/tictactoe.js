...
let activePlayer = 'X';
//This array stores an array of moves which is used to determine win conditions.
let selectedSquares = [];

//This function is for placing an x or o in a square.
function placeXOrO(squareNumber) {
    //This conedition ensures a square hasn't been selected already.
...
function audio(audioURL) {
    //a new audio object is created and is passed the path as a parameter.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let
        ...
        y2 = coordY2,
        //This variable stores temporary x axis data which is updated in the animation loop.
        x = x1,
        //This variable stores temporary y axis data which is updated in the animation loop.
        y = y1;
